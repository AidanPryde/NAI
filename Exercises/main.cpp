...
int main(int argc, const char* argv[])
{
	try
	{
		...
		//Logic logic("C:\\Users\\Pesi\\Documents\\GitHubVisualStudio\\NAI-exercises\\Exercises"); // PC
		Logic logic("C:\\Users\\Márton\\Documents\\Visual Studio 2015\\Projects\\NAI exercises\\Exercises"); // LAPTOP
		//Logic logic;
